      ...
      <section style={{ background: C.background, padding: '32px 16px', boxSizing: 'border-box' as const, width: '100%' }}>
        <div style={{ maxWidth: 1056, margin: '0 auto', width: '100%', boxSizing: 'border-box' }}>
          <div style={{ background: C.notificationBgInfo, borderLeft: `4px solid ${C.supportInfo}`, padding: S.s5, display: 'flex', gap: S.s4, alignItems: 'flex-start' }}>
            ...
            {/* ── FOOTER ── */}
      <footer style={{ background: C.shellBg, borderTop: '1px solid #393939', padding: '24px 16px' }}>
        <div style={{ maxWidth: 1056, margin: '0 auto' }}>

          {/* 링크 바 */}
          <div style={{ marginBottom: 16 }}>
            <span style={{ fontSize: 12, fontWeight: 600, color: '#f4f4f4', marginRight: 16, fontFamily: 'IBM Plex Sans, sans-serif' }}>바로가기</span>
            <a href="https://www.comwel.or.kr/" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: C.interactive, marginRight: 12, textDecoration: 'none', fontFamily: 'IBM Plex Sans, sans-serif' }}>근로복지공단</a>
            <a href="https://www.comwel.or.kr/comwel/info/data/papr/papr_lst.jsp" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: C.interactive, marginRight: 12, textDecoration: 'none', fontFamily: 'IBM Plex Sans, sans-serif' }}>고용산재토탈</a>
            <a href="https://www.gov.kr/" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: C.interactive, marginRight: 12, textDecoration: 'none', fontFamily: 'IBM Plex Sans, sans-serif' }}>정부24</a>
            <a href="tel:1588-0075" style={{ fontSize: 13, color: C.interactive, textDecoration: 'none', fontFamily: 'IBM Plex Sans, sans-serif' }}>1588-0075</a>
          </div>

          {/* 저작권 */}
          <p style={{ fontSize: 11, color: '#6f6f6f', margin: 0, fontFamily: 'IBM Plex Sans, sans-serif', lineHeight: '16px' }}>
