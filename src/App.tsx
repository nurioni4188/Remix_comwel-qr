...
export default function App() {
  ...
  const ListView = () => (
    <motion.div key="list" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: .18 }}>
      ...
      <section style={{ background: C.shellBg, padding: 'clamp(32px, 6vw, 80px) clamp(16px, 5vw, 48px)' }}>
      ...
      {/* ── CARDS SECTION ── */}
      <section style={{ background: C.layer01, padding: 'clamp(32px, 5vw, 64px) clamp(16px, 5vw, 48px)' }}>
        <div style={{ maxWidth: 1056, margin: '0 auto' }}>
      ...
      <section style={{ background: C.background, padding: 'clamp(32px, 5vw, 64px) clamp(16px, 5vw, 48px)' }}>
        <div style={{ maxWidth: 1056, margin: '0 auto' }}>
      ...
      {/* ── GLOSSARY (Gray 100) ── */}
      <section style={{ background: C.shellBg, padding: 'clamp(32px, 5vw, 64px) clamp(16px, 5vw, 48px)' }}>
        <div style={{ maxWidth: 1056, margin: '0 auto' }}>
      ...
      {/* ── DISCLAIMER ── */}
      <section style={{ background: C.background, padding: 'clamp(24px, 4vw, 40px) clamp(16px, 5vw, 48px)' }}>
        <div style={{ maxWidth: 1056, margin: '0 auto' }}>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ background: C.shellBg, padding: 'clamp(32px, 5vw, 48px) clamp(16px, 5vw, 48px) 24px', borderTop: `1px solid #393939` }}>
        <div style={{ maxWidth: 1056, margin: '0 auto' }}>
  ...
  const DetailView = ({ card }: { card: ComplaintCard }) => {
    ...
    return (
      <motion.div key="detail" initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -16 }} transition={{ duration: .18 }}>
        ...
        {/* Breadcrumb nav */}
        <div style={{ background: C.layer01, padding: '12px 16px', borderBottom: `1px solid ${C.borderSubtle01}`, position: 'sticky', top: 48, zIndex: 40 }}>
        ...
        {/* Page header */}
        <section style={{ background: C.shellBg, padding: 'clamp(32px, 5vw, 48px) 16px' }}>
          <div style={{ maxWidth: 1056, margin: '0 auto' }}>
        ...
        {/* Body */}
        <div style={{ maxWidth: 1056, margin: '0 auto', padding: '0 16px 80px' }}>

          {/* Two-col layout on wide */}
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr)', gap: S.s7, alignItems: 'start' }}>
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.background, fontFamily: "'IBM Plex Sans', 'Noto Sans KR', sans-serif", color: C.textPrimary }}>
      ...
      {/* UI Shell header */}
      <header style={{ position: 'sticky', top: 0, zIndex: 50, background: C.shellBg, height: 48, display: 'flex', alignItems: 'center', padding: '0 16px', justifyContent: 'space-between', borderBottom: '1px solid #393939' }}>
        <button onClick={() => { setSelectedCardId(null); scrollTop(); }}
          style={{ ...T.heading01, color: C.shellText, background: 'none', border: 'none', cursor: 'pointer', fontFamily: "'IBM Plex Sans', sans-serif", letterSpacing: '.16px', flexShrink: 0 }}>
          COMWEL QR
        </button>

        {/* Nav links — 데스크탑에서만 표시 */}
        <nav style={{ display: 'flex', alignItems: 'center', gap: 0, overflow: 'hidden' }}
          className="desktop-nav">
          {['자주 찾는 민원', '가입지원', '재활보상', '복지·지원'].map(nav => (
            <button key={nav}
              onClick={() => { setActiveCategory(nav === '복지·지원' ? '복지·지원 사업' : nav); setSelectedCardId(null); scrollTop(); }}
              style={{ height: 48, padding: `0 12px`, background: 'none', border: 'none', fontSize: 13, color: '#c6c6c6', cursor: 'pointer', fontFamily: "'IBM Plex Sans', 'Noto Sans KR', sans-serif", whiteSpace: 'nowrap', display: 'flex', alignItems: 'center' }}
        ...
        <div style={{ display: 'flex', gap: 0, flexShrink: 0 }}>
          <a href="tel:1588-0075"
            style={{ height: 48, padding: `0 12px`, display: 'flex', alignItems: 'center', ...T.body01, color: '#c6c6c6', textDecoration: 'none', fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 13 }}>
            1588-0075
          </a>
          <a href="https://www.comwel.or.kr/" target="_blank" rel="noopener noreferrer"
            style={{ height: 48, padding: `0 12px`, display: 'flex', alignItems: 'center', gap: 4, background: C.interactive, fontSize: 13, color: C.textOnColor, fontWeight: 600, textDecoration: 'none', fontFamily: "'IBM Plex Sans', sans-serif", whiteSpace: 'nowrap' }}>
            공식 홈페이지
          </a>
        </div>
      </header>
