...
export default function App() {
  ...
  const ListView = () => (
    <motion.div key="list" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: .18 }}>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ background: C.shellBg, padding: '40px 16px 24px', boxSizing: 'border-box' as const, width: '100%', borderTop: `1px solid #393939` }}>
        <div style={{ maxWidth: 1056, margin: '0 auto', width: '100%', boxSizing: 'border-box' }}>
  ...
  const DetailView = ({ card }: { card: ComplaintCard }) => {
    ...
    return (
      <motion.div key="detail" initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -16 }} transition={{ duration: .18 }}>
        ...
        {/* Breadcrumb nav */}
        <div style={{ background: C.layer01, padding: '12px 16px', borderBottom: `1px solid ${C.borderSubtle01}`, position: 'sticky', top: 48, zIndex: 40, width: '100%', boxSizing: 'border-box' }}>
        ...
        {/* Body */}
        <div style={{ maxWidth: 1056, margin: '0 auto', padding: '0 16px 80px', width: '100%', boxSizing: 'border-box' }}>
  ...
  /* ── Global Shell ─────────────────────────────── */
  return (
    <div style={{ minHeight: '100vh', width: '100%', overflowX: 'hidden', background: C.background, fontFamily: "'IBM Plex Sans', 'Noto Sans KR', sans-serif", color: C.textPrimary }}>
