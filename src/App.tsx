  ...
  const ListView = () => (
    <motion.div key="list" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: .18 }}>
      ...
      <footer style={{ background: C.shellBg, padding: '32px 16px 24px', borderTop: `1px solid #393939`, boxSizing: 'border-box', width: '100%' }}>
        <div style={{ maxWidth: 1056, margin: '0 auto', width: '100%', boxSizing: 'border-box' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '24px 16px', marginBottom: 24, paddingBottom: 24, borderBottom: '1px solid #393939' }}>

            <div>
              <div style={{ fontSize: 12, fontWeight: 600, color: C.shellText, marginBottom: 12, fontFamily: "'IBM Plex Sans', 'Noto Sans KR', sans-serif" }}>민원 안내</div>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 8 }}>
                {['요양급여', '휴업급여', '이직확인서', '장해급여'].map((l, j) => (
                  <li key={j}><span style={{ fontSize: 13, color: '#c6c6c6', fontFamily: "'IBM Plex Sans', 'Noto Sans KR', sans-serif" }}>{l}</span></li>
                ))}
              </ul>
            </div>

            <div>
              <div style={{ fontSize: 12, fontWeight: 600, color: C.shellText, marginBottom: 12, fontFamily: "'IBM Plex Sans', 'Noto Sans KR', sans-serif" }}>가입지원</div>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <div>
              <div style={{ fontSize: 12, fontWeight: 600, color: C.shellText, marginBottom: 12, fontFamily: "'IBM Plex Sans', 'Noto Sans KR', sans-serif" }}>복지 사업</div>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <div>
              <div style={{ fontSize: 12, fontWeight: 600, color: C.shellText, marginBottom: 12, fontFamily: "'IBM Plex Sans', 'Noto Sans KR', sans-serif" }}>공식 채널</div>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 8 }}>
                {[
                  ...
                  <li key={j}>
                    <a href={l.href} target={l.href.startsWith('tel') ? '_self' : '_blank'} rel="noopener noreferrer"
                      style={{ fontSize: 13, color: C.interactive, textDecoration: 'none', fontFamily: "'IBM Plex Sans', 'Noto Sans KR', sans-serif", display: 'inline-flex', alignItems: 'center', gap: 4 }}>
          ...
          <div style={{ fontSize: 11, color: '#6f6f6f', fontFamily: "'IBM Plex Sans', sans-serif", lineHeight: '16px' }}>
