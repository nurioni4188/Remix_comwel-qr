...
export default function App() {
  ...
  const ListView = () => (
    <motion.div key="list" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: .18 }}>
      ...
      <section style={{ background: C.shellBg, padding: `${S.s9} ${S.s5}` }}>
      ...
      {/* ── CARDS SECTION ── */}
      <section style={{ background: C.layer01, padding: `${S.s8} ${S.s5}` }}>
        <div style={{ maxWidth: 1056, margin: '0 auto' }}>
      ...
      <section style={{ background: C.background, padding: `${S.s8} ${S.s5}` }}>
        <div style={{ maxWidth: 1056, margin: '0 auto' }}>
      ...
      {/* ── GLOSSARY (Gray 100) ── */}
      <section style={{ background: C.shellBg, padding: `${S.s8} ${S.s5}` }}>
        <div style={{ maxWidth: 1056, margin: '0 auto' }}>
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.background, fontFamily: "'IBM Plex Sans', 'Noto Sans KR', sans-serif", color: C.textPrimary }}>
      ...
      {/* UI Shell header */}
      <header style={{ position: 'sticky', top: 0, zIndex: 50, background: C.shellBg, height: 48, display: 'flex', alignItems: 'center', padding: `0 ${S.s5}`, justifyContent: 'space-between', borderBottom: '1px solid #393939' }}>
